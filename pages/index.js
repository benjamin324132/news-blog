...
import { Inter, Lat } from 'next/font/google'
    ...
    <>
      ...
      max-w-7xl">
            ...
            <div class="grid grid-cols-12 sm:px-5 gap-x-8 gap-y-16">
              {posts.map((post) => {
                return (<div class="flex flex-col items-start col-span-12 space-y-3 sm:col-span-6 xl:col-span-4">
                  <img
                    src={post.imageUrl} class="object-cover w-full mb-2 overflow-hidden rounded-lg shadow-sm max-h-56 btn-" />
            ...
            rounded-full uppercase inline-block">Entertainment</p>
                  <Link href={`/${post.category}/${post.slug}`} class="text-lg font-bold sm:text-xl md:text-2xl">{post.title}</Link>

                  <div class="pt-1 pr-0 pb-0 pl-0">
